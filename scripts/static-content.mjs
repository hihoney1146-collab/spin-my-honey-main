...
<section>
  ...
  <p>The names, numbers, or options you type into the wheel stay on your device and are never sent to a server. No accounts, sign-ups, or passwords are required. To keep the tool free, we use standard, privacy-respecting analytics, and ad measurement if advertising is enabled, described in our <a href="/privacy-policy">Privacy Policy</a>. If you email us, we use your address and message only to reply.</p>
</section>
...
<section><h2>Google Analytics, Consent Mode, and AdSense</h2><p>We use Google Analytics for aggregated traffic insight. Online Spin Wheel has integrated Google AdSense. Advertisements will be displayed once our AdSense account is approved and ad serving is enabled. When ads are served, Google and its advertising partners may use cookies or similar technologies for advertising, measurement, fraud prevention and, where permitted, personalization. Google Consent Mode loads advertising and analytics tags with consent defaults set to denied until you accept cookies; your choice updates consent via gtag. If advertising is enabled, Google's DoubleClick DART cookie may serve ads based on your visits; opt out at <a href="https://policies.google.com/technologies/ads" rel="noopener noreferrer">policies.google.com/technologies/ads</a>.</p></section>
...
<li><strong>Targeting &amp; advertising (only if advertising is enabled)</strong>, Google AdSense/DoubleClick DART for ads and measurement; up to 13 months.</li>
</ul></section>
...
<section><h2>Google Consent Mode</h2><p>Analytics, and AdSense where enabled, load with Consent Mode defaults set to denied until you choose Accept or Decline. Personalized ads and ad-related storage apply only after Accept. Our banner is a custom implementation, not a Google-certified CMP for the EEA/UK/CH.</p></section>
...
<section><h2>Ad-supported model</h2><p>The Service is 100% free. Online Spin Wheel has integrated Google AdSense. Ads are not live yet and may appear after Google approves the account and we enable serving. By using the site you agree we may display third-party advertisements (such as Google AdSense) and use analytics providers, subject to our <a href="/privacy-policy">Privacy Policy</a> and <a href="/cookie-policy">Cookie Policy</a>.</p></section>
...
<section><h2>Advertising and ad-network disclaimer</h2><p>To keep the tool free, Online Spin Wheel has integrated Google AdSense. If and when Google approves the account and we turn ads on, third-party ads may appear on the site. If advertising is enabled, we partner with third-party networks including Google AdSense. The presence of an advertisement is not an endorsement, we do not control which specific ads are served, and any interactions or purchases with advertisers are solely between you and the advertiser.</p></section>
