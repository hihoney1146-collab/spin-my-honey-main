...
export const bestIcebreakerGamesOfficeMeetings: BlogPost = {
  ...
  blocks: [
    {
      heading: "1. Why wheel-first icebreakers work on Zoom and hybrid calls",
      paragraphs: [
        "Remote and hybrid US teams often open meetings with silence while everyone waits for the host to pick who speaks first. Spin the wheel icebreaker games fix that awkward gap in under five minutes: the wheel, not the manager, chooses the next voice, and the prompt is already on screen before anyone un-mutes.",
        "Unlike static question lists, a live spin gives remote participants something to watch while cameras load. In-room colleagues see the same animation on the conference-room display, so hybrid groups share one focal point instead of two different experiences.",
        "Every format below requires spinning our wheel. If an activity does not start with a spin, it is not in this guide. That narrow scope keeps prep time low: paste prompts once, share your screen, and run the same flow on Monday stand-ups and Friday retros.",
        "Facilitators tell us the hardest part is not thinking of questions, it is choosing who goes first without playing favorites. A name wheel makes that decision visible to the whole call, which matters when you manage distributed teams across US time zones and cannot read body language the way you would in a physical break room.",
      ],
    },
    {
    ...
    {
      heading: "4. Hybrid rooms: one wheel, two audiences",
      paragraphs: [
        "When half the team is in a conference room and half on Zoom, lag and side conversations can kill icebreakers before they start. Display the same spin tab on the room projector and the host's shared screen so everyone sees the landing slice at the same moment.",
        "Ask in-room participants to stay muted until the wheel stops; remote colleagues do the same. Call on the selected person by name twice, once for the room, once for the stream, to reduce \"I did not know it was me\" moments. Keep a backup phone hotspot if conference Wi-Fi drops; wheels run in the browser without installs.",
        "If your room microphone picks up applause or chatter when the wheel lands, mute the conference speaker briefly during the spin animation, then un-mute for the answer. Remote workers report that small step makes prompts easier to hear and keeps the five-minute block from spilling into slide one.",
      ],
      images: [
        {
    ...
    {
      heading: "6. Open your next stand-up with one spin",
      paragraphs: [
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Cap at five minutes including one or two spins. Use the run sheet checklist in this guide and a visible timer so the agenda stays on track.",
    },
    {
      q: "Do these activities work for hybrid teams?",
      a: "Yes. Display the same wheel on the conference-room screen and the host's shared tab so in-room and remote attendees see results simultaneously.",
    },
    {
      q: "Can I avoid picking the same person twice?",
      a: "Enable remove-after-pick on name wheels. Each selected slice drops off until you reset the list, and session history logs the order of picks.",
    },
    {
      q: "Are truth-or-dare prompts safe for work?",
      a: "Use only the professional truths and mild camera dares listed in Truth or Dare Lite. Skip dare slices on client-facing or executive calls.",
    },
    {
