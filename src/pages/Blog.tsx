        ...
        <Card className="p-6 md:p-8 lg:p-10 mt-8 space-y-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Comprehensive guides to help you master spin wheels
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Interactive color picker tool for designers, artists, and
                        creatives. Perfect for design inspiration and color decisions.
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-4 hover:shadow-lg transition-shadow h-full">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        The ultimate guide to fair, fun random winner selection for giveaways, raffles, and events
                      </p>
                    </div>
                  </div>
                </Card>
        ...
        <Card className="p-8 md:p-10 mt-8 border shadow-sm">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              <a
                href="https://www.youtube.com/channel/UCgRqE6q28Wc286vUEpZH_Sg"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/1aSNv4gguy/"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-3 px-5 py-3 rounded-lg border-2 border-border hover:border-blue-600 bg-background hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-all duration-200"
