...
Generated 2026-09-05 from built `dist/` HTML, the exact bytes served to a no-JS crawler (equivalent to `curl` against production).
...
| `/author/raja-jahangir` | 497 | PASS |
| `/author/zoha-zeeshan` | 516 | PASS |
| `/blog` | 593 | PASS |
| `/blog/best-icebreaker-games-office-meetings` | 1972 | PASS |
| `/blog/best-spin-wheel-games-for-students` | 1965 | PASS |
| `/blog/classroom-spinner-beyond-name-picking` | 943 | PASS |
| `/blog/fair-raffle-without-paper-tickets` | 1409 | PASS |
| `/blog/spin-wheel-team-building-activities` | 1001 | PASS |
...
| `/comparison-spin-wheel-vs-traditional-methods` | 562 | PASS |
| `/contact-us` | 532 | PASS |
| `/cookie-policy` | 405 | PASS |
| `/date-night-wheel` | 531 | PASS |
| `/dinner-picker-wheel` | 500 | PASS |
| `/disclaimer` | 417 | PASS |
| `/how-randomness-works` | 530 | PASS |
...
| `/wheel-of-names-alternative` | 606 | PASS |
